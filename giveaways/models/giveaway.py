    ...
    async def _handle_flags(self):
        ...
        if msg:
            kwargs["embed"] = discord.Embed(
                title=f"**<a:NCR_PlagueDoctorDancing:1011416910929346580> Giveaway! <a:NCR_PlagueDoctorDancing:1011416910929346580>**", description=f"**Message:** {msg}", color=await self.get_embed_color()
            )
